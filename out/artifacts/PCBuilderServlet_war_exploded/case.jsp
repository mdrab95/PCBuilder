...
<div class="container">
    <h1 class="col-sm-12">Case list:</h1>
    <form action="${pageContext.request.contextPath}/case" method="post">
        <div class="form-group col-sm-11">
            <input type="text" class="form-control" name="caseSearchText">
        </div>
        <div class="col-sm-1">
            <button type="submit" class="btn btn-default" name="caseSearchButton" value="caseSearchButton">Search</button>
        </div>
    </form>
